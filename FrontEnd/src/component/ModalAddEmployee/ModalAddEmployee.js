...
import {actionAddEmployee, actionEditEmployee} from "../../redux-store/action/actionEmployee";

 export const ModalAddEmployee=React.memo((props)=>{
    const { isShowModalEditUser, onClose} = props
    const cx = classNames.bind(styles);
     ...
     useEffect(()=>{
         ...
         setIsActive(1)
         setIsAdmin(0)
         setJobTitleId(dataListJobtitle[0]?.jobtitleId)
         setDepartmentId(dataListDepartment[0]?.departmentId)
         setPositionLevel(3)
         setAvatarUser(null)
     },[isShowModalEditUser])
                    ...
                    <div style={style.modalContent}>
                        ...
                        <div className={cx('flex')}>
                           ...
                           <div  onClick={handleEdit} style={style.buttonEdit}>
                               <div style={style.textEdit}>Thêm nhân viên</div>
                           </div>
                    </div>
                </div> : null}
        </div>
