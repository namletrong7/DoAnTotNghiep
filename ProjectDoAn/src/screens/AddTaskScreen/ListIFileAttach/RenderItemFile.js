...
export const  RenderItemFile = React.memo((props) => {
  return(
    <TouchableOpacity onPress={()=>props.handleDelete(props.index)} style={{marginTop: 5, borderRadius:10,paddingVertical:2, borderWidth:1,borderColor:"#CCCCCC", alignItems:"center",height:90,width:70,marginRight:5}}>
