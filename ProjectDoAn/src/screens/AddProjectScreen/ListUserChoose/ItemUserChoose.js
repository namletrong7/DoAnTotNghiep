...
import React from "react";
 ...
 export const ItemUserChoose=React.memo((props)=>{
  ...
  return (
    <TouchableOpacity onPress={()=>{handleItem(item.userId)}} style={{flexDirection:"row", borderRadius:14, backgroundColor:"#DDDDDD", flex:0.5, marginHorizontal:5,marginVertical:2,paddingVertical:3, alignItems:'center'}}>
      <FastImage
