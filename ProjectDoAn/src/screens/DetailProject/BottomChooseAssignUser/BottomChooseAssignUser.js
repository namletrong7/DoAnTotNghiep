...
export const BottomChooseAssignUser=React.memo((props)=>{
    ...
    <BottomSheetModalProvider>
      <BottomSheetModal
        ...
        <ScrollView style={{backgroundColor:"white"}} >
          <View style={{paddingHorizontal:10, backgroundColor:"white",marginBottom:"30%"}}>
            <Text style={{fontSize:18,alignSelf:'center',marginVertical:10, color:"black",fontFamily:"OpenSans-SemiBold",fontWeight:'700',marginRight:10}}>{"Lọc theo người duyệt"}</Text>
            ...
            />
          <TouchableOpacity onPress={handleFilterTask} style={{height:50,alignSelf:'center', paddingHorizontal:9, borderRadius:17, backgroundColor:"#daeefd",alignItems:'center', justifyContent:'center'}}>
            <Text style={{
              fontSize: 15,
              color: "#2f88dc",
