...
export const AddFileAttachScreen:React.FC<AddFileAttachScreenProps> = React.memo(({navigation,route})=>{
  ...
  return (
    ...
    >
      ...
      <TouchableOpacity  style={{height:50,bottom:20,alignSelf:'center',paddingHorizontal:50, borderRadius:17, backgroundColor:"#4577ef", marginTop:30,alignItems:'center', justifyContent:'center'}}>
        <Text style={{
          fontSize: 17,
          color: "white",
